...
var get_transform_value = function(e, t) {
	...
	INDEX = function() {
		...
		var x = $("#loading"),
			T = $("#loading_text"),
			N = function() {
				var e = ["images/iphone.png","images/01.jpg","images/02.jpg","images/03.jpg","images/04.jpg","images/05.jpg"],
					t = e.length,
					n = 0,
					r = function(e) {
						var r = new Image;
				...
				var s = 60,
					o = function() {
						0 >= s ? n / t > .5 ? u() : alert("输入的有问题!") : (s -= .5, n == t ? u() : setTimeout(o, 500))
					},
					u = function() {};
				return function(e) {
...
//		}, function(e) {})
//	}
//	var e = "http://www.h12320.com",
//		t = "http://www.h12320.com",
//		n = "http://www.h12320.com",
//		r = "http://www.h12320.com";
