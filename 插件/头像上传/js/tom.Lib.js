...
//css3 event
    ...
    _.cropImage=function(opts){
        ...
        function getCropInfo(){
            ...
            return {x:x,y:y,dWidth:dWidth,dHeight:dHeight,scale:scale,iWidth:iWidth,iHeight:iHeight,whRatio:whRatio}
        }
        function getCropFile(option){
            ...
            ctx.drawImage(G.preview,x,y, o.dWidth, o.dHeight);
//          if(option.x&&option.y){
//          	ctx.drawImage(G.preview,option.x,option.y, preview.dWidth, preview.dHeight);
//          }else{
